...
| `<leader>mt` | Normal | Toggle custom visual tables in the current buffer; they are off by default, with RenderMarkdown native tables active (`:MarkdownTablesToggle`) |
