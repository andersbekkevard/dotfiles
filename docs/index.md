...
| Daily usage, verify, maintenance | `docs/usage.md` | Operating the dotfiles repo itself: bootstrap, verify, stow, local overrides, and the single entrypoint |
...
Boundary reminder:
- `docs/usage.md` is for using and maintaining the dotfiles repo, not for teaching the general usage of installed tools.
