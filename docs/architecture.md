...
The shared Ghostty configuration under `terminals/` removes an inherited
`NO_COLOR` variable from commands it launches. This keeps terminal color under
the command's own control even when a GUI launcher exports `NO_COLOR=1`.
