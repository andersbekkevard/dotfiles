---
name: autoreview
description: "Auto Review closeout. Codex review is the default when no engine is set and is the recommended reviewer. Thermonuclear mode swaps in the maximum-strictness maintainability rubric when Anders asks for a thermonuclear review."
---
