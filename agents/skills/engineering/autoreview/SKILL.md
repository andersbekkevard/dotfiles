...
- user asks for Codex review / thermonuclear review / Claude review / Pi review / autoreview / second-model review
...
thermonuclear_prompt=$(<"$skills_root/thermo-nuclear-code-quality-review/SKILL.md")
"$AUTOREVIEW" --mode branch --base origin/main \
  --prompt "$thermonuclear_prompt" \
  --max-priority P3
```
