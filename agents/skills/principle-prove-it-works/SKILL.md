...
Keep the artifact visible for the human. Commit it only when the task needs a durable audit trail, such as a large port or migration. Most work just needs the proof visible, not committed.
